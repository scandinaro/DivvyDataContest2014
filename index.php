...
<body>
	...
	<div class="graph-wrapper top">
        ...
        <h2>Intro</h2>
        <h3>placeholder... This box should give 3 general charts side by side - maybe men vs women (which can filter by age), the ages broken out (which can filter by sex), and customer vs subscriber. We should also explain how to use the filter, and say that it works for each chart.</h3>
    ...
    <div class="graph-wrapper">
        ...
        <h2>Heat Map of Divvy Activity</h2>
        <h3>Listed is a map of the stations</h3>
